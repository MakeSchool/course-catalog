...
<table>
  <tr>
    <td>
      <strong>Contact Hours (Synchronous)</strong>
    </td>
    <td>
      <strong>Non-Contact Hours (Asynchronous)</strong>
    </td>
  </tr>
  <tr>
    <td>
      12.5 hours of instruction <strong>X</strong> # of credits
      <hr />
      <p> # of weeks in class </p>
    </td>
    <td>
      30 hours of instruction <strong>X</strong> # of credits
      <hr />
      <p> # of weeks in class </p>
    </td>
  </tr>
